...
# 1. Torne este script executável:
#    sudo chmod +x /home/pi/api_raspberry_pi/src/scripts/configurar_wifi.sh
...
#    pi ALL=(ALL) NOPASSWD: /home/pi/api_raspberry_pi/src/scripts/configurar_wifi.sh
...
#    execFile('sudo', ['/home/pi/api_raspberry_pi/src/scripts/configurar_wifi.sh', ssid, password], callback);
...
#    sudo /home/pi/api_raspberry_pi/src/scripts/configurar_wifi.sh "NomeRede" "SenhaRede"
...
/configurar_wifi.sh', ssid, password], callback);
...
/configurar_wifi.sh "NomeRede" "SenhaRede"
